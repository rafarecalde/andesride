...
| `SUCCESS_URL` | e.g. `https://quitoairporttransfers.com/success` |
| `CANCEL_URL` | e.g. `https://quitoairporttransfers.com/#book` |
...
| `ALLOWED_ORIGIN` | `https://quitoairporttransfers.com` (CORS) |
